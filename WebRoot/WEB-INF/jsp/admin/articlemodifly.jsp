...
<html>
	...
	<body>
	    <form action="${pageContext.request.contextPath }/admin/abbsupdateArticleservlet" method="post" class="definewidth m20" onsubmit="return check()" >
			<table class="table table-bordered table-hover definewidth m10">
		        ...
		        <tr>
		            ...
		            <td>
		            	<textarea name="content" id="content" style="width:100%;">${bbs.content}</textarea>
		            </td>
		        </tr>
		        <tr>
			...
			<input type="hidden" name="articleId" value="${bbs.id }"/>
		</form>
	</body>
</html>
