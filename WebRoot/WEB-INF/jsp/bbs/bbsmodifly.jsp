     	...
     	<form action="" name="form1" method="post" class="definewidth m20" onsubmit="return check()" >
			<table class="table table-bordered table-hover definewidth m10">
		        <tr>
		            ...
		            <td>
		            	<input type="text" id="title" name="title" value="${formodiflyarticle.title }"/>
		            </td>
		        </tr>		
		        <tr>
		            <td width="10%" class="tableleft">公告内容</td>
		            <td>
		            	<textarea name="content" id="content" rows="20" style="width:100%;">${formodiflyarticle.content }</textarea>
		            </td>
		        </tr>
		        <tr>
...
<script type="text/javascript">
		...
		$('#backid').click(function(){
				location = "${pageContext.request.contextPath}/draftbbsservlet?id="+1;
		});
		...
		function doSubmit(i)
		{
			...
			    {
			      case 1:
			       form1.action="${pageContext.request.contextPath }/addbbsdraftservlet";//(此处自己改)
			       break;
			      case 2:
			       form1.action="${pageContext.request.contextPath }/addbbsArticleservlet";//(此处自己改)
			    } 
		}
</script>
