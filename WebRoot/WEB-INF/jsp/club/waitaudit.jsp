...
<html>
  ...
  <body>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		...
		<c:if test="${pageBean.currentPage!=1 }">
				<a href="${pageContext.request.contextPath}/draftclubservlet?currentPage=${pageBean.currentPage-1 }&id=2" aria-label="Previous">
					<span aria-hidden="true">&laquo;</span>
				</a>
		</c:if>
		...
		<c:forEach begin="1" end="${pageBean.totalPage }" var="page">
			...
			<c:if test="${page!=pageBean.currentPage }">
				<a href="${pageContext.request.contextPath}/draftclubservlet?currentPage=${page }&id=2">&nbsp;&nbsp;${page }&nbsp;&nbsp;</a>
			</c:if>
		</c:forEach>
		...
		<c:if test="${pageBean.currentPage!=pageBean.totalPage }">
				<a href="${pageContext.request.contextPath}/draftclubservlet?currentPage=${pageBean.currentPage+1 }&id=2" aria-label="Next"> 
					<span aria-hidden="true">&raquo;</span>
				</a>
		</c:if>
