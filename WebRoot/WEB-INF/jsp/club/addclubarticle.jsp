...
<script type="text/javascript">
		...
		$('#backid').click(function(){
				location = "${pageContext.request.contextPath}/Introduceservle?clubintroid=1";
		});
		...
		function doSubmit(i)
		{
			...
			    {
			      case 1:
			       form1.action="${pageContext.request.contextPath }/addnewclubdraftservlet";//(此处自己改)
			       break;
			      case 2:
			       form1.action="${pageContext.request.contextPath }/addnewclubArticleservlet";//(此处自己改)
			    } 
		}
</script>
