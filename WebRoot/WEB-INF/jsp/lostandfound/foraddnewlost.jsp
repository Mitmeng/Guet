...
<html>
  ...
  <body>
     ...
     <img id="top" alt="图片" src="img/lost.jpg" width="100%"><br>
     <div>&nbsp;&nbsp;</div>
     <div class="col" style="width: 70%;background:#FFFFD0; padding: 20px 20px 20px 20px;border: 3px solid #ccc;">
		<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/addnewlostservlet" method="post" enctype="multipart/form-data" style="margin-top: 5px;">
			...
			<div class="form-group opt">
				...
				<div class="col-sm-7">
					<label class="radio-inline"> 
						<input  type="radio" name="lostorfount" id="lost" value="1"  >失物招领
					</label> 
					<label class="radio-inline"> 
						<input type="radio" name="lostorfount" id="fount" value="0">寻物启示
					</label>
				</div>
			</div>
...
<script type="text/javascript" language="JavaScript">
	...
	$('#backid').click(function(){
			location = "${pageContext.request.contextPath}/lostandfountlistservlet";
	});
