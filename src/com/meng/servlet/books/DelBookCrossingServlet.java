...
public class DelBookCrossingServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean issuccess = bookCrossingDao.delebookbyid(stuid,articleId);
		if(issuccess){
			response.sendRedirect(request.getContextPath()+"/booktypeforbookservlet");
		}else{
