...
public class ClubWaitListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			pageBean = service.findClubArticleList(1,title,currentPage,currentCount);
		...
		//跳转到文章管理页面
		request.getRequestDispatcher("/WEB-INF/jsp/admin/clubwaitlist.jsp").forward(request, response);
	}
